...
void uart_init()
{
	...
	//Fraction part register = (.627 * 64) + 0.5 = 40.6 = ~40.
	mmio_write(UART0_IBRD, 1);
	mmio_write(UART0_FBRD, 40);

	//Enable the FIFO & 8 bit data transmission (1 stop bit, no parity).
...
void uart_write(const unsigned char* buff, size_t size)
{
